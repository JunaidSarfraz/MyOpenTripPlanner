...
package org.opentripplanner.updater.telepod_rental;
 ...
 * </pre>
 */
public class TelepodRentalUpdater extends PollingGraphUpdater {

    private static final Logger LOG = LoggerFactory.getLogger(TelepodRentalUpdater.class);
    ...
    private TelepodRentalDataSource source;
    ...
    protected void configurePolling (Graph graph, JsonNode config) throws Exception {
        ...
        TelepodRentalDataSource source = null;
        if (sourceType != null) {
            if (sourceType.equals("telepoddev")) {
                source = new TelepodRRentalDataSource(networkName);
            }
        }
