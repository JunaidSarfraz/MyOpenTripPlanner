 ...
 */
public class AnyWheelBikeRentalDataSource extends GenericJsonBikeRentalDataSource {

    private String networkName;

    public AnyWheelBikeRentalDataSource(String networkName) {
        super("");
        if (networkName != null && !networkName.isEmpty()) {
            this.networkName = networkName;
        } else {
            this.networkName = "AnyWheel";
        }
    }
    ...
    public BikeRentalStation makeStation(JsonNode stationNode) {
        ...
        brstation.id = networkName+" "+stationNode.path("stationId").toString();
        ...
        brstation.bikesAvailable = stationNode.path("AnyWheelAvail").asInt();
