 ...
 */
public class OBikeRentalDataSource extends GenericJsonBikeRentalDataSource {

    private String networkName;

    public OBikeRentalDataSource(String networkName) {
        super("");
        if (networkName != null && !networkName.isEmpty()) {
            this.networkName = networkName;
        } else {
            this.networkName = "OBike";
        }
    }
    ...
    public BikeRentalStation makeStation(JsonNode stationNode) {
        ...
        brstation.id = networkName+"_"+stationNode.path("stationId").toString();
        ...
        brstation.bikesAvailable = stationNode.path("obikeAvail").asInt();
